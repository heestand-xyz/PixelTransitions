...
Pod::Spec.new do |spec|
  ...
  spec.name         = "PixelTransitions"
  spec.version      = "1.0"
  spec.summary      = "Transitions for Views"
  ...
  spec.description  = <<-DESC
  					          a collection transitions for views.
                      DESC
  ...
  spec.source       = { :git => "https://github.com/hexagons/PixelTransitions.git", :branch => "master", :tag => "#{spec.version}" }
